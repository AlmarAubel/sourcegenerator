...
### IfBrackets.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [IfBrackets.Sample.csproj](../IfBrackets.Sample/IfBrackets.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 
